...
function initTrainingRequestPage() {
    ...
    // Пользователь авторизован и зарегистрирован - показываем его данные
    ...
    contentDiv.innerHTML = `
        <div style="background: var(--bg-card); border-radius: 16px; padding: 40px; border: 1px solid var(--border-color); box-shadow: 0 8px 32px rgba(0,0,0,0.1);">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                ${user.discord_id ? `
                    <div style="display: flex; align-items: center; justify-content: center; gap: 8px; color: var(--text-secondary); font-size: 16px; margin-top: 8px;">
