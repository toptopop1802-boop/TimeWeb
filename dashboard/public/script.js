...
if (window.__API_PAGE_ACTIVE__ || window.location.hash === '#api') {
    ...
    if (btnPlay) {
        btnPlay.addEventListener('mouseenter', () => {
            ...
            if (cardsGlow) cardsGlow.style.opacity = '0.41';
            if (cardsBackground) cardsBackground.style.filter = 'grayscale(0)';
        });
        ...
        btnPlay.addEventListener('mouseleave', () => {
            ...
            if (cardsGlow) cardsGlow.style.opacity = '0';
            if (cardsBackground) cardsBackground.style.filter = 'grayscale(1)';
        });
