        ...
        private void ShowUI(BasePlayer player)
        {
            ...
            elements.Add(new CuiPanel
            {
                ...
                CursorEnabled = false
                    ...
                    {
                        Text = { Text = "<", FontSize = 128, Align = TextAnchor.MiddleCenter, Color = "0.765 0.765 0.765 1.000" },
                    ...
                    elements.Add(new CuiPanel
                    {
                        ...
                        RectTransform = { AnchorMin = "0.0758 -0.0160", AnchorMax = "0.9242 1.0160" }
                        ...
                        {
                            Image = { Color = "1 1 1 0.5" },
                            RectTransform = { AnchorMin = "0.0894 0.0155", AnchorMax = "1.0894 1.0155" }
                            ...
                            {
                                Image = { Color = "1 1 1 0.5" },
                                RectTransform = { AnchorMin = "0.1519 0.1462", AnchorMax = "1.0894 0.9089" }
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/1J5KX12" },
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/1DZSXZ8" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/6JYQO70" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "Куда ложить твой лут?", FontSize = 32, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                                RectTransform = { AnchorMin = "0.3330 0.2648", AnchorMax = "0.5229 0.2973" }
                            }, "batle_pass_fifnsih_ebani_batlepass_0");

                            // Text: Поставь переключатель туда куда тебе нужно забирать награды. Либо в игровой инветраь, либо в инвентарь плагина.
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "Выбери куда получать награды: в игровой инвентарь или в инвентарь плагина.", FontSize = 13, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "В инвентарь плагина", FontSize = 13, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "В инвентарь", FontSize = 13, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "#4", FontSize = 48, Align = TextAnchor.MiddleCenter, Color = "0.945 0.627 0.267 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "#1", FontSize = 48, Align = TextAnchor.MiddleCenter, Color = "0.945 0.627 0.267 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "Вип награды", FontSize = 32, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "Заходи на сервер каждый день и получай награды за каждый день захода. Чем дальше тем пиздаче призы", FontSize = 13, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "#2", FontSize = 48, Align = TextAnchor.MiddleCenter, Color = "0.945 0.627 0.267 1.000" },
                            ...
                            {
                                Text = { Text = "Вип награды", FontSize = 32, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                                RectTransform = { AnchorMin = "0.8207 0.7845", AnchorMax = "1.0106 0.8170" }
                            }, "batle_pass_fifnsih_ebani_batlepass_0");
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "#3", FontSize = 48, Align = TextAnchor.MiddleCenter, Color = "0.945 0.627 0.267 1.000" },
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/92UEOM0" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "НАГРАДЫ", FontSize = 24, Align = TextAnchor.MiddleCenter, Color = "0.945 0.627 0.267 1.000" },
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/1S9E81S" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "ИНВЕНТАРЬ", FontSize = 23, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "День 1", FontSize = 15, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "?", FontSize = 15, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "День 2", FontSize = 15, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/286DY3I" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            // Text: Внутри хуйня очень вкусное
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "Внутри хуйня очень вкусное", FontSize = 15, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            {
                                Image = { Color = "1 1 1 0.5" },
                                RectTransform = { AnchorMin = "1.0207 0.3951", AnchorMax = "1.0354 0.4269" }
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/1ZDX3MT" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "ПОЛУЧИТЬ", FontSize = 14, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "24:00:00", FontSize = 14, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiLabel
                            {
                                Text = { Text = "НЕ ДОСТУПЕН", FontSize = 14, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/6HCK4QV" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            {
                                Image = { Color = "1 1 1 0.5" },
                                RectTransform = { AnchorMin = "0.9180 0.3771", AnchorMax = "1.0225 0.6003" }
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/289RUBT" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiPanel
                            {
                                ...
                                {
                                    Text = { Text = "Внутри хуйня очень вкусное", FontSize = 15, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                                    RectTransform = { AnchorMin = "7.1530 -0.6321", AnchorMax = "7.6922 -0.5637" }
                                ...
                                {
                                    Image = { Color = "1 1 1 0.5" },
                                    RectTransform = { AnchorMin = "7.7974 0.1687", AnchorMax = "8.0404 0.2512" }
                                ...
                                elements.Add(new CuiElement
                                {
                                    ...
                                    Components =
                                    {
                                        new CuiRawImageComponent { Url = "https://bublickrust.ru/i/241CDLC" },
                                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                    }
                                });
                                ...
                                elements.Add(new CuiLabel
                                {
                                    Text = { Text = "НУЖЕН ВИП СТАТУС", FontSize = 13, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                                    RectTransform = { AnchorMin = "7.0404 -0.7488", AnchorMax = "7.8523 -0.7146" }
                                }, "batlepass_group_29_48");
                            ...
                            {
                                Image = { Color = "1 1 1 0.5" },
                                RectTransform = { AnchorMin = "0.9111 0.3876", AnchorMax = "1.0024 0.8233" }
                                ...
                                {
                                    Image = { Color = "1 1 1 0.5" },
                                    RectTransform = { AnchorMin = "9.9786 -0.4055", AnchorMax = "10.9786 0.5945" }
                                    ...
                                    {
                                        Text = { Text = "Внутри хуйня очень вкусное", FontSize = 15, Align = TextAnchor.MiddleLeft, Color = "1.000 1.000 1.000 1.000" },
                                        RectTransform = { AnchorMin = "10.3583 -0.3147", AnchorMax = "10.8449 -0.2596" }
                                    }, "group_31_group_30_0");

                                    // Text: НЕ ДОСТУПНО
                                    elements.Add(new CuiLabel
                                    {
                                        Text = { Text = "НЕ ДОСТУПНО", FontSize = 14, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                                        RectTransform = { AnchorMin = "10.2460 -0.4055", AnchorMax = "10.9786 -0.3779" }
                                    }, "group_31_group_30_0");
                                    ...
                                    {
                                        Image = { Color = "1 1 1 0.5" },
                                        RectTransform = { AnchorMin = "9.9786 0.0159", AnchorMax = "10.2032 0.1180" }
                                    ...
                                    {
                                        Image = { Color = "1 1 1 0.5" },
                                        RectTransform = { AnchorMin = "10.0949 0.4924", AnchorMax = "10.3195 0.5945" }
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/2T2YAUO" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/22LG43I" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/1V5GWN5" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                            ...
                            elements.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiRawImageComponent { Url = "https://bublickrust.ru/i/26WQ1KS" },
                                    new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                                }
                            });
                        ...
                        elements.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiRawImageComponent { Url = "https://bublickrust.ru/i/18YFJ22" },
                                new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                            }
                        });
                        ...
                        elements.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiRawImageComponent { Url = "https://bublickrust.ru/i/ENII390" },
                                new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                            }
                        });
                        ...
                        elements.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiRawImageComponent { Url = "https://bublickrust.ru/i/Y9AMX10" },
                                new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                            }
                        });
                        ...
                        {
                            Image = { Color = "1 1 1 0.5" },
                            RectTransform = { AnchorMin = "0.4883 0.2684", AnchorMax = "1.0386 0.7613" }
                        ...
                        elements.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiRawImageComponent { Url = "https://bublickrust.ru/i/5NJ8WZ8" },
                                new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                            }
                        });
                        ...
                        elements.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiRawImageComponent { Url = "https://bublickrust.ru/i/2AR2M68" },
                                new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                            }
                        });
                        ...
                        elements.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiRawImageComponent { Url = "https://bublickrust.ru/i/4FZDLEG" },
                                new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                            }
                        });
                        ...
                        {
                            Text = { Text = "?", FontSize = 15, Align = TextAnchor.MiddleCenter, Color = "1.000 1.000 1.000 1.000" },
                            RectTransform = { AnchorMin = "0.9990 0.5671", AnchorMax = "1.0156 0.5904" }
                        }, "frame_20_batle_pass_fifnsih_ebani_1");
